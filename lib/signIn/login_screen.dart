                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const [
                        ...
                        Expanded(
                          child: Text(
                            'Important: The verification email is often delivered to your Gmail Spam / Junk folder. Please make sure to check there.',
                            style: TextStyle(
                              fontSize: 12,
                    ...
                    Expanded(
                      child: OutlinedButton(
                          ...
                          try {
                            ...
                            if (mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Verification email resent! Check your inbox & Spam / Junk folder.',
                                  ),
                        ...
                        style: OutlinedButton.styleFrom(
                          side: const BorderSide(color: Color(0xFF6055D8)),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10),
                          ),
